...
describe('Utils', () => {
  ...
  describe('isEqual (Arrys)', () => {
    it('should not be equal if content are different', () => {
    ...
    it('should be equal if content are the same', () => {
    ...
    it('should be equal if array object are the same', () => {
      const item1 = [
  ...
  describe('isEqual (Objects)', () => {
    it('should not be equal if objects are different', () => {
    ...
    it('should be equal if objects are the same', () => {
